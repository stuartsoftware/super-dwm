...
/* The Modifications will have an '!', you can modify this as you taste! mmmm  -StuartSoftware */
...
//static const char *dwmexit[] = {"sh dwmexit.sh", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_cyan, "-sf", col_gray4, NULL};
static const Key keys[] = {
	/* modifier                     key        function        argument */
        { MODKEY,			XK_d,	   spawn,	   SHCMD("rofi -show-icons -show drun")}, // !
	{ MODKEY,			XK_p,  	   spawn,    	   SHCMD("xfce4-screenshooter")}, // !
	{ MODKEY|ShiftMask, 		XK_e,      spawn,          SHCMD("dwmexit")}, // !
